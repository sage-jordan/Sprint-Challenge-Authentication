...
To be able to keep a user authenticated when using the site.

- [x] What does bcrypt do to help us store passwords in a secure manner.

It hash's the password and decrypts them for us.

- [x] What does bcrypt do to slow down attackers?

It stores the passwords as hash's, which can only be decryped by the algorythm that made it.
